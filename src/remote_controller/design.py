...
<<<<<<< HEAD
        ...
        self.label_28.setGeometry(QtCore.QRect(10, 190, 151, 20))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Monospace"))
=======
...
<<<<<<< HEAD
        ...
        self.txtWTemp = QtGui.QLineEdit(self.frame_2)
        self.txtWTemp.setEnabled(False)
        self.txtWTemp.setGeometry(QtCore.QRect(170, 190, 61, 20))
        self.txtWTemp.setObjectName(_fromUtf8("txtWTemp"))
...
<<<<<<< HEAD
        ...
        self.label_28.setText(_translate("MainWindow", "Water Temp (C):", None))
